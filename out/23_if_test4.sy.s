...
if_ifElse_:
              #                    mem layout:|ra_if_ifElse_:8 at 24|s0_if_ifElse_:8 at 16|a:4 at 12|b:4 at 8|temp_0_cmp:1 at 7|temp_1_cmp:1 at 6|none:2 at 4|temp_2_arithop:4 at 0
    addi    sp,sp,-32
              #                    store to ra_if_ifElse__0 in mem offset legal
    sd      ra,24(sp)
              #                    store to s0_if_ifElse__0 in mem offset legal
    sd      s0,16(sp)
    addi    s0,sp,32
              #                          alloc i32 a_17 
              #                          alloc i32 b_17 
...
.branch_false_26:
              #                          new_var temp_2_arithop_25:i32 
              #                          temp_2_arithop_25 = Add i32 a_17, 15_0 
              #                    occupy a0 with a_17
              #                    occupy a2 with 15_0
    li      a2, 15
              #                    occupy a5 with temp_2_arithop_25
    add     a5,a0,a2
              #                    free a0
              #                    free a2
              #                    free a5
              #                          a_17 = i32 temp_2_arithop_25 
              #                    occupy a5 with temp_2_arithop_25
              #                    occupy a0 with a_17
    mv      a0, a5
              #                    free a5
              #                    free a0
              #                          jump label: L3_0 
              #                    store to temp_2_arithop_25 in mem offset legal
    sw      a5,0(sp)
              #                    release a5 with temp_2_arithop_25
    j       .L3_0
              #                    regtab     a0:Freed { symidx: a_17, tracked: true } |     a1:Freed { symidx: b_17, tracked: true } |     a3:Freed { symidx: temp_0_cmp_22, tracked: true } |     a4:Freed { symidx: temp_1_cmp_25, tracked: true } | 
              #                          label L3_0: 
.L3_0:
...
.L4_0:
              #                          ret a_17 
              #                    load from ra_if_ifElse__0 in mem
    ld      ra,24(sp)
              #                    load from s0_if_ifElse__0 in mem
    ld      s0,16(sp)
    ...
    .type main,@function
main:
              #                    mem layout:|ra_main:8 at 16|s0_main:8 at 8|temp_3_ret_of_if_ifElse_:4 at 4|none:4 at 0
    addi    sp,sp,-24
    ...
    sd      s0,8(sp)
    addi    s0,sp,24
              #                          alloc i32 temp_3_ret_of_if_ifElse__31 
              #                    regtab 
              #                          label L0_0: 
.L0_0:
              #                          new_var temp_3_ret_of_if_ifElse__31:i32 
              #                          temp_3_ret_of_if_ifElse__31 =  Call i32 if_ifElse__0() 
    ...
    call    if_ifElse_
              #                    store to temp_3_ret_of_if_ifElse__31 in mem offset legal
    sw      a0,4(sp)
              #                          ret temp_3_ret_of_if_ifElse__31 
    ...
    ld      s0,8(sp)
              #                    store to temp_3_ret_of_if_ifElse__31 in mem offset legal
    sw      a0,4(sp)
              #                    release a0 with temp_3_ret_of_if_ifElse__31
              #                    occupy a0 with temp_3_ret_of_if_ifElse__31
              #                    load from temp_3_ret_of_if_ifElse__31 in mem
