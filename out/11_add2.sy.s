...
.section ___func
    ...
    .type main,@function
main:
              #                    mem layout:|ra_main:8 at 24|s0_main:8 at 16|a:4 at 12|b:4 at 8|temp_0_arithop:4 at 4|temp_1_arithop:4 at 0
    addi    sp,sp,-32
...
.L0_0:
    ...
    add     a2,a0,a1
              ...
              #                    free a1
              #                    free a2
              #                           Call void putint_0(temp_0_arithop_17) 
    ...
    sw      a2,4(sp)
              ...
              #                    arg load start
              #                    occupy a0 with _anonymous_of_temp_0_arithop_17_0
    ...
    call    putint
              ...
              #                          temp_1_arithop_17 = Add i32 a_17, b_17 
              #                    occupy a0 with a_17
    ...
    lw      a1,8(sp)
              #                    occupy a2 with temp_1_arithop_17
    add     a2,a0,a1
              #                    free a0
              #                    free a1
              #                    free a2
    ...
    sw      a2,0(sp)
              #                    release a2 with temp_1_arithop_17
              #                    store to a_17 in mem offset legal
    sw      a0,12(sp)
              #                    release a0 with a_17
