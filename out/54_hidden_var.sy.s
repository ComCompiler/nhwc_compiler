...
.while.exit_32:
    ...
    add     s9,s9,s9
                    ...
                    #found literal reg Some(s10) already exist with 3_0
    sd      s10,0(s9)
                    #      mu c_46:96 
                    #      c_46 = chi c_46:96 
                    #      new_var temp_11_46:ptr->i32 
                    #      temp_11_46 = getelementptr c_46:Array:i32:[Some(2_0), Some(8_0)] [Some(0_0), Some(0_0)] 
    li      s11, 0
                    #found literal reg Some(s4) already exist with 8_0
                    #found literal reg Some(a6) already exist with 0_0
    add     s11,s11,s5
    ...
    add     s11,s11,sp
    add     s11,s11,s11
                    #      store 0_0:i32 temp_11_46:ptr->Array:i32:[Some(8_0)] 
                    #found literal reg Some(a6) already exist with 0_0
    sd      a6,0(s11)
                    #      mu c_46:102 
                    #      c_46 = chi c_46:102 
