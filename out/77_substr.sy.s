...
.L0_0:
                    ...
                    #      temp_54_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(20_0)] 
    li      a0, 0
    li      a1, 1
    li      a2, 20
    mul     a3,a1,a2
    ...
    sd      a4,0(a0)
                    ...
                    #      temp_55_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(11_0)] 
    li      a5, 0
    ...
    add     a5,a5,sp
    add     a5,a5,a5
                    #      store 8_0:i32 temp_55_62:ptr->i32 
    li      a7, 8
    sd      a7,0(a5)
                    #      mu A_62:258 
                    #      A_62 = chi A_62:258 
    ...
    sd      a4,0(s1)
                    ...
                    #      temp_57_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(19_0)] 
    li      s3, 0
                    #found literal reg Some(a1) already exist with 1_0
    li      s4, 19
    add     s3,s3,a3
    ...
    add     s3,s3,sp
    add     s3,s3,s3
                    #      store 3_0:i32 temp_57_62:ptr->i32 
    li      s5, 3
    sd      s5,0(s3)
                    #      mu A_62:270 
                    #      A_62 = chi A_62:270 
    ...
    sd      s7,0(s6)
                    ...
                    #      temp_59_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(10_0)] 
    li      s8, 0
                    #found literal reg Some(a1) already exist with 1_0
    li      s9, 10
    add     s8,s8,a3
    ...
    add     s8,s8,sp
    add     s8,s8,s8
                    #      store 4_0:i32 temp_59_62:ptr->i32 
    li      s10, 4
    sd      s10,0(s8)
                    #      mu A_62:282 
                    #      A_62 = chi A_62:282 
                    #      new_var temp_60_62:ptr->i32 
                    #      temp_60_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(14_0)] 
    li      s11, 0
                    #found literal reg Some(a1) already exist with 1_0
    li      a2, 14
    add     s11,s11,a3
    ...
    add     s11,s11,sp
    add     s11,s11,s11
                    #      store 0_0:i32 temp_60_62:ptr->i32 
    li      a1, 0
    sd      a1,0(s11)
                    #      mu A_62:288 
                    #      A_62 = chi A_62:288 
                    #      new_var temp_61_62:ptr->i32 
                    #      temp_61_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(12_0)] 
    li      a1, 0
                    #found literal reg Some(s2) already exist with 1_0
    li      a2, 12
    add     a1,a1,a3
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_61_62:ptr->i32 
                    #found literal reg Some(s5) already exist with 3_0
    sd      s5,0(a1)
                    #      mu A_62:294 
                    #      A_62 = chi A_62:294 
                    #      new_var temp_62_62:ptr->i32 
                    #      temp_62_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(16_0)] 
    li      a2, 0
                    #found literal reg Some(s2) already exist with 1_0
    li      a4, 16
    add     a2,a2,a3
    ...
    sd      a6,0(a4)
                    ...
                    #      temp_64_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(17_0)] 
    li      a6, 0
                    #found literal reg Some(s2) already exist with 1_0
    li      a7, 17
    add     a6,a6,a3
    ...
    sd      s10,0(a6)
                    ...
                    #      temp_65_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(6_0)] 
    li      a7, 0
                    #found literal reg Some(s2) already exist with 1_0
    li      s4, 6
    add     a7,a7,a3
    ...
    sd      s2,0(a7)
                    ...
                    #      temp_66_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(2_0)] 
    li      s2, 0
    li      s4, 1
    li      s5, 2
    add     s2,s2,a3
    ...
    add     s2,s2,sp
    add     s2,s2,s2
                    #      store 4_0:i32 temp_66_62:ptr->i32 
                    #found literal reg Some(s10) already exist with 4_0
    sd      s10,0(s2)
                    #      mu A_62:324 
                    #      A_62 = chi A_62:324 
                    #      new_var temp_67_62:ptr->i32 
                    #      temp_67_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(21_0)] 
    li      s4, 0
    li      s5, 1
    li      s7, 21
    add     s4,s4,a3
    ...
    add     s4,s4,sp
    add     s4,s4,s4
                    #      store 0_0:i32 temp_67_62:ptr->i32 
    li      s5, 0
    sd      s5,0(s4)
                    #      mu A_62:330 
                    #      A_62 = chi A_62:330 
                    #      new_var temp_68_62:ptr->i32 
                    #      temp_68_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(5_0)] 
    li      s5, 0
    li      s7, 1
    li      s9, 5
    add     s5,s5,a3
    ...
    add     s5,s5,sp
    add     s5,s5,s5
                    #      store 7_0:i32 temp_68_62:ptr->i32 
    li      s7, 7
    sd      s7,0(s5)
                    #      mu A_62:336 
                    #      A_62 = chi A_62:336 
                    #      new_var temp_69_62:ptr->i32 
                    #      temp_69_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(13_0)] 
    li      s7, 0
    li      s9, 1
    li      s10, 13
    add     s7,s7,a3
    ...
    sd      a0,0(s9)
                    ...
                    #      temp_71_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(15_0)] 
    li      a0, 0
    ...
    sd      s10,0(a1)
                    ...
                    #      temp_73_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(0_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,288(sp)
    li      a1, 0
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_74_62 = getelementptr A_62:Array:i32:[Some(15_0)] [Some(3_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,280(sp)
    li      a0, 3
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 1_0:i32 temp_74_62:ptr->i32 
                    #found literal reg Some(s10) already exist with 1_0
    sd      s10,0(a1)
                    #      mu A_62:372 
                    #      A_62 = chi A_62:372 
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_76_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(3_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,264(sp)
    li      a0, 3
    ...
    sd      s10,0(a1)
                    ...
                    #      temp_77_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(4_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,192(sp)
    li      a1, 4
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 4_0:i32 temp_77_62:ptr->i32 
                    #found literal reg Some(a1) already exist with 4_0
    sd      a1,0(a0)
                    #      mu B_62:392 
                    #      B_62 = chi B_62:392 
                    #      new_var temp_78_62:ptr->i32 
                    #      temp_78_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(7_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,184(sp)
    li      a0, 7
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_79_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(8_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,176(sp)
    li      a1, 8
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 6_0:i32 temp_79_62:ptr->i32 
    li      a1, 6
    sd      a1,0(a0)
                    #      mu B_62:404 
                    #      B_62 = chi B_62:404 
                    #      new_var temp_80_62:ptr->i32 
                    #      temp_80_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(9_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,168(sp)
    li      a0, 9
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 8_0:i32 temp_80_62:ptr->i32 
    li      a0, 8
    sd      a0,0(a1)
                    #      mu B_62:410 
                    #      B_62 = chi B_62:410 
                    #      new_var temp_81_62:ptr->i32 
                    #      temp_81_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(11_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,160(sp)
    li      a1, 11
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 1_0:i32 temp_81_62:ptr->i32 
                    #found literal reg Some(s10) already exist with 1_0
    sd      s10,0(a0)
                    #      mu B_62:416 
                    #      B_62 = chi B_62:416 
                    #      new_var temp_82_62:ptr->i32 
                    #      temp_82_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(1_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,152(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 9_0:i32 temp_82_62:ptr->i32 
    li      a0, 9
    sd      a0,0(a1)
                    #      mu B_62:422 
                    #      B_62 = chi B_62:422 
                    #      new_var temp_83_62:ptr->i32 
                    #      temp_83_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(10_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,144(sp)
    li      a1, 10
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 0_0:i32 temp_83_62:ptr->i32 
    li      a1, 0
    sd      a1,0(a0)
                    #      mu B_62:428 
                    #      B_62 = chi B_62:428 
                    #      new_var temp_84_62:ptr->i32 
                    #      temp_84_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(15_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,136(sp)
    li      a0, 15
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_86_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(5_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,120(sp)
    li      a0, 5
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 2_0:i32 temp_86_62:ptr->i32 
    li      a0, 2
    sd      a0,0(a1)
                    #      mu B_62:446 
                    #      B_62 = chi B_62:446 
                    #      new_var temp_87_62:ptr->i32 
                    #      temp_87_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(14_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,112(sp)
    li      a1, 14
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_88_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(6_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,104(sp)
    li      a0, 6
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 4_0:i32 temp_88_62:ptr->i32 
    li      a0, 4
    sd      a0,0(a1)
                    #      mu B_62:458 
                    #      B_62 = chi B_62:458 
                    #      new_var temp_89_62:ptr->i32 
                    #      temp_89_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(12_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,96(sp)
    li      a1, 12
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 5_0:i32 temp_89_62:ptr->i32 
    li      a1, 5
    sd      a1,0(a0)
                    #      mu B_62:464 
                    #      B_62 = chi B_62:464 
                    #      new_var temp_90_62:ptr->i32 
                    #      temp_90_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(0_0)] 
    li      a1, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a0,88(sp)
    li      a0, 0
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_91_62 = getelementptr B_62:Array:i32:[Some(13_0)] [Some(2_0)] 
    li      a0, 0
                    #found literal reg Some(s10) already exist with 1_0
    sd      a1,80(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_91_62:ptr->i32 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu B_62:476 
                    #      B_62 = chi B_62:476 
