...
.L1_0:
    ...
    lb      a0,6(sp)
              #                    free a0
              #                    store to temp_8_ptr2globl_29 in mem offset legal
    sw      s1,104(sp)
              #                    release s1 with temp_8_ptr2globl_29
              #                    occupy a0 with temp_35_logic_29
    bnez    a0, .branch_true_30
              #                    free a0
    j       .branch_false_30
              #                    regtab     a0:Freed { symidx: temp_35_logic_29, tracked: true } |     a1:Freed { symidx: temp_28_arithop_29, tracked: true } |     a2:Freed { symidx: temp_34_cmp_29, tracked: true } |     a3:Freed { symidx: temp_5_ptr2globl_29, tracked: true } |     a4:Freed { symidx: temp_16_arithop_29, tracked: true } |     a5:Freed { symidx: temp_6_ptr2globl_29, tracked: true } |     a6:Freed { symidx: temp_7_arithop_29, tracked: true } |     a7:Freed { symidx: temp_20_arithop_29, tracked: true } |     s10:Freed { symidx: temp_14_ptr2globl_29, tracked: true } |     s11:Freed { symidx: temp_21_arithop_29, tracked: true } |     s2:Freed { symidx: temp_17_ptr2globl_29, tracked: true } |     s3:Freed { symidx: temp_9_ptr2globl_29, tracked: true } |     s4:Freed { symidx: temp_18_ptr2globl_29, tracked: true } |     s5:Freed { symidx: temp_10_ptr2globl_29, tracked: true } |     s6:Freed { symidx: temp_11_arithop_29, tracked: true } |     s7:Freed { symidx: temp_12_arithop_29, tracked: true } |     s8:Freed { symidx: temp_13_cmp_29, tracked: true } |     s9:Freed { symidx: temp_19_ptr2globl_29, tracked: true } | 
              #                          label branch_true_30: 
.branch_true_30:
              #                          flag_22 = i32 1_0 
              #                    occupy s1 with flag_22
    li      s1, 1
              #                    free s1
              #                          jump label: branch_false_30 
              #                    store to flag_22 in mem offset legal
    sw      s1,120(sp)
              #                    release s1 with flag_22
    j       .branch_false_30
              #                    regtab     a0:Freed { symidx: temp_35_logic_29, tracked: true } |     a1:Freed { symidx: temp_28_arithop_29, tracked: true } |     a2:Freed { symidx: temp_34_cmp_29, tracked: true } |     a3:Freed { symidx: temp_5_ptr2globl_29, tracked: true } |     a4:Freed { symidx: temp_16_arithop_29, tracked: true } |     a5:Freed { symidx: temp_6_ptr2globl_29, tracked: true } |     a6:Freed { symidx: temp_7_arithop_29, tracked: true } |     a7:Freed { symidx: temp_20_arithop_29, tracked: true } |     s10:Freed { symidx: temp_14_ptr2globl_29, tracked: true } |     s11:Freed { symidx: temp_21_arithop_29, tracked: true } |     s2:Freed { symidx: temp_17_ptr2globl_29, tracked: true } |     s3:Freed { symidx: temp_9_ptr2globl_29, tracked: true } |     s4:Freed { symidx: temp_18_ptr2globl_29, tracked: true } |     s5:Freed { symidx: temp_10_ptr2globl_29, tracked: true } |     s6:Freed { symidx: temp_11_arithop_29, tracked: true } |     s7:Freed { symidx: temp_12_arithop_29, tracked: true } |     s8:Freed { symidx: temp_13_cmp_29, tracked: true } |     s9:Freed { symidx: temp_19_ptr2globl_29, tracked: true } | 
