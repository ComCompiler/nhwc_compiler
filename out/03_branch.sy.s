...
.branch_true_25:
    ...
    lb      s4,13(sp)
              ...
              #                    load from temp_3_logic_27 in mem
    lb      s5,12(sp)
              #                    free s5
              #                    occupy s5 with temp_3_logic_27
...
.branch_true_39:
    ...
    li      a7, 0
              #                    occupy s10 with false_0
    or      s10,a6,a7
              #                    free a6
              #                    free a7
              #                    free s10
              #                          br i1 temp_9_logic_41, label branch_true_42, label branch_false_42 
              #                    occupy s11 with temp_9_logic_41
              #                    load from temp_9_logic_41 in mem
    lb      s11,6(sp)
              #                    free s11
              #                    occupy s11 with temp_9_logic_41
    bnez    s11, .branch_true_42
              #                    free s11
    j       .branch_false_42
              #                    regtab     a0:Freed { symidx: a_17, tracked: true } |     a1:Freed { symidx: b_17, tracked: true } |     a2:Freed { symidx: c_17, tracked: true } |     a3:Freed { symidx: d_17, tracked: true } |     a4:Freed { symidx: e_17, tracked: true } |     a5:Freed { symidx: f_17, tracked: true } |     s11:Freed { symidx: temp_9_logic_41, tracked: true } |     s1:Freed { symidx: temp_0_logic_24, tracked: true } |     s2:Freed { symidx: temp_1__27, tracked: true } |     s3:Freed { symidx: temp_4_logic_30, tracked: true } |     s4:Freed { symidx: temp_2__27, tracked: true } |     s5:Freed { symidx: temp_3_logic_27, tracked: true } |     s6:Freed { symidx: temp_5__34, tracked: true } |     s7:Freed { symidx: temp_8_cmp_38, tracked: true } |     s8:Freed { symidx: temp_6__34, tracked: true } |     s9:Freed { symidx: temp_7_logic_34, tracked: true } | 
...
.branch_false_42:
    ...
    li      a6, 3
              #                    occupy a7 with 6_0
    li      a7, 6
              #                    occupy s10 with temp_10_cmp_45
    xor     s10,a6,a7
    snez    s10, s10
              #                    free a6
              #                    free a7
    ...
    bnez    s10, .branch_true_46
              #                    free s10
    j       .branch_false_46
              #                    regtab     a0:Freed { symidx: a_17, tracked: true } |     a1:Freed { symidx: b_17, tracked: true } |     a2:Freed { symidx: c_17, tracked: true } |     a3:Freed { symidx: d_17, tracked: true } |     a4:Freed { symidx: e_17, tracked: true } |     a5:Freed { symidx: f_17, tracked: true } |     s10:Freed { symidx: temp_10_cmp_45, tracked: true } |     s11:Freed { symidx: temp_9_logic_41, tracked: true } |     s1:Freed { symidx: temp_0_logic_24, tracked: true } |     s2:Freed { symidx: temp_1__27, tracked: true } |     s3:Freed { symidx: temp_4_logic_30, tracked: true } |     s4:Freed { symidx: temp_2__27, tracked: true } |     s5:Freed { symidx: temp_3_logic_27, tracked: true } |     s6:Freed { symidx: temp_5__34, tracked: true } |     s7:Freed { symidx: temp_8_cmp_38, tracked: true } |     s8:Freed { symidx: temp_6__34, tracked: true } |     s9:Freed { symidx: temp_7_logic_34, tracked: true } | 
...
.branch_true_49:
              ...
              #                          temp_12_booltrans_51 = icmp i1 Ne 6_0, 0_0 
              #                    occupy a6 with 6_0
    li      a6, 6
              #                    occupy a7 with 0_0
    li      a7, 0
