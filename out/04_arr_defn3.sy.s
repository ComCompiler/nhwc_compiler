...
.L0_0:
    ...
    sd      a6,0(a0)
                    ...
                    #      temp_1_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a7, 0
    ...
    add     a7,a7,sp
    add     a7,a7,a7
                    #      store 2_0:i32 temp_1_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a1) already exist with 2_0
    sd      a1,0(a7)
                    #      mu b_17:28 
                    #      b_17 = chi b_17:28 
                    #      new_var temp_2_17:ptr->i32 
                    #      temp_2_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      s2, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a4) already exist with 1_0
    add     s2,s2,a3
    ...
    sd      s6,0(s5)
                    ...
                    #      temp_5_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      s7, 0
                    #found literal reg Some(a1) already exist with 2_0
    li      s8, 2
    add     s7,s7,a3
    ...
    add     s7,s7,sp
    add     s7,s7,s7
                    #      store 6_0:i32 temp_5_17:ptr->Array:i32:[Some(2_0)] 
    li      s9, 6
    sd      s9,0(s7)
                    #      mu b_17:52 
                    #      b_17 = chi b_17:52 
                    #      new_var temp_6_17:ptr->i32 
                    #      temp_6_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s10, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a4) already exist with 1_0
    add     s10,s10,a3
    ...
    add     s10,s10,sp
    add     s10,s10,s10
                    #      store 3_0:i32 temp_6_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a2) already exist with 3_0
    sd      a2,0(s10)
                    #      mu b_17:58 
                    #      b_17 = chi b_17:58 
    ...
    sd      s6,0(a1)
                    ...
                    #      temp_9_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a2, 0
                    #found literal reg Some(s8) already exist with 2_0
                    #found literal reg Some(s1) already exist with 0_0
    add     a2,a2,a4
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 2_0:i32 temp_9_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(s8) already exist with 2_0
    sd      s8,0(a2)
                    #      mu c_17:78 
                    #      c_17 = chi c_17:78 
    ...
    sd      s1,0(a6)
                    ...
                    #      temp_12_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      s1, 0
                    #found literal reg Some(s8) already exist with 2_0
    li      s3, 1
    add     s1,s1,a4
    ...
    add     s1,s1,sp
    add     s1,s1,s1
                    #      store 4_0:i32 temp_12_17:ptr->Array:i32:[Some(2_0)] 
    li      s3, 4
    sd      s3,0(s1)
                    #      mu c_17:96 
                    #      c_17 = chi c_17:96 
                    #      new_var temp_13_17:ptr->i32 
                    #      temp_13_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s3, 0
                    #found literal reg Some(s8) already exist with 2_0
    li      s6, 3
    add     s3,s3,a4
    ...
    add     s3,s3,sp
    add     s3,s3,s3
                    #      store 8_0:i32 temp_13_17:ptr->Array:i32:[Some(2_0)] 
    li      s6, 8
    sd      s6,0(s3)
                    #      mu c_17:102 
                    #      c_17 = chi c_17:102 
                    #      new_var temp_14_17:ptr->i32 
                    #      temp_14_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      s6, 0
    li      s8, 2
    li      s9, 2
    add     s6,s6,a4
    ...
    add     s6,s6,sp
    add     s6,s6,s6
                    #      store 6_0:i32 temp_14_17:ptr->Array:i32:[Some(2_0)] 
    li      s8, 6
    sd      s8,0(s6)
                    #      mu c_17:108 
                    #      c_17 = chi c_17:108 
                    #      new_var temp_15_17:ptr->i32 
                    #      temp_15_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s8, 0
    li      s9, 2
    sd      a0,456(sp)
    li      a0, 1
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_21_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
    li      s9, 2
    sd      a0,232(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_21_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 3
    sd      a0,0(a1)
                    #      mu d_17:152 
                    #      d_17 = chi d_17:152 
    ...
    sd      a0,0(a2)
                    ...
                    #      temp_33_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a0, 0
    li      a1, 2
    sd      a2,104(sp)
    li      a2, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 6_0:i32 temp_33_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 6
    sd      a1,0(a0)
                    #      mu e_17:214 
                    #      e_17 = chi e_17:214 
