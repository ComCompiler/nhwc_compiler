...
.L0_0:
    ...
    sd      s5,0(s3)
                    ...
                    #      temp_3_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      s6, 0
                    #found literal reg Some(s1) already exist with 2_0
    ...
    add     s6,s6,sp
    add     s6,s6,s6
                    #      store 1_0:i32 temp_3_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a5) already exist with 1_0
    sd      a5,0(s6)
                    #      mu b_17:40 
                    #      b_17 = chi b_17:40 
                    #      new_var temp_4_17:ptr->i32 
                    #      temp_4_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      s7, 0
                    #found literal reg Some(s1) already exist with 2_0
                    #found literal reg Some(a5) already exist with 1_0
    add     s7,s7,a3
    ...
    add     s7,s7,sp
    add     s7,s7,s7
                    #      store 4_0:i32 temp_4_17:ptr->Array:i32:[Some(2_0)] 
    li      s8, 4
    sd      s8,0(s7)
                    #      mu b_17:46 
                    #      b_17 = chi b_17:46 
    ...
    sd      s10,0(s9)
                    ...
                    #      temp_6_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s11, 0
                    #found literal reg Some(s1) already exist with 2_0
                    #found literal reg Some(s4) already exist with 0_0
    add     s11,s11,a3
    ...
    add     s11,s11,sp
    add     s11,s11,s11
                    #      store 2_0:i32 temp_6_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(s1) already exist with 2_0
    sd      s1,0(s11)
                    #      mu b_17:58 
                    #      b_17 = chi b_17:58 
                    #      new_var temp_7_17:ptr->i32 
                    #      temp_7_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
                    #found literal reg Some(s1) already exist with 2_0
                    #found literal reg Some(a5) already exist with 1_0
    add     a1,a1,a3
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_7_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a2) already exist with 3_0
    sd      a2,0(a1)
                    #      mu b_17:64 
                    #      b_17 = chi b_17:64 
                    ...
                    #      temp_8_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a2, 0
                    #found literal reg Some(s1) already exist with 2_0
    li      a4, 2
    mul     a5,s1,a4
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 6_0:i32 temp_8_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(s2) already exist with 6_0
    sd      s2,0(a2)
                    #      mu c_17:72 
                    #      c_17 = chi c_17:72 
    ...
    sd      a6,0(a4)
                    ...
                    #      temp_10_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a6, 0
                    #found literal reg Some(s1) already exist with 2_0
    li      s2, 2
    add     a6,a6,a5
    ...
    sd      s10,0(a6)
                    ...
                    #      temp_11_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s1, 0
    ...
    add     s1,s1,sp
    add     s1,s1,s1
                    #      store 8_0:i32 temp_11_17:ptr->Array:i32:[Some(2_0)] 
    li      s2, 8
    sd      s2,0(s1)
                    #      mu c_17:90 
                    #      c_17 = chi c_17:90 
                    #      new_var temp_12_17:ptr->i32 
                    #      temp_12_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(0_0)] 
    li      s2, 0
    li      s4, 2
    li      s5, 3
    add     s2,s2,a5
    ...
    add     s2,s2,sp
    add     s2,s2,s2
                    #      store 7_0:i32 temp_12_17:ptr->Array:i32:[Some(2_0)] 
    li      s4, 7
    sd      s4,0(s2)
                    #      mu c_17:96 
                    #      c_17 = chi c_17:96 
                    #      new_var temp_13_17:ptr->i32 
                    #      temp_13_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s4, 0
    li      s5, 2
    li      s8, 0
    add     s4,s4,a5
    ...
    add     s4,s4,sp
    add     s4,s4,s4
                    #      store 2_0:i32 temp_13_17:ptr->Array:i32:[Some(2_0)] 
    li      s5, 2
    sd      s5,0(s4)
                    #      mu c_17:102 
                    #      c_17 = chi c_17:102 
                    #      new_var temp_14_17:ptr->i32 
                    #      temp_14_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s5, 0
    li      s8, 2
    li      s10, 1
    add     s5,s5,a5
    ...
    add     s5,s5,sp
    add     s5,s5,s5
                    #      store 3_0:i32 temp_14_17:ptr->Array:i32:[Some(2_0)] 
    li      s8, 3
    sd      s8,0(s5)
                    #      mu c_17:108 
                    #      c_17 = chi c_17:108 
                    #      new_var temp_15_17:ptr->i32 
                    #      temp_15_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      s8, 0
    li      s10, 2
    sd      a0,456(sp)
    li      a0, 1
    ...
    add     s8,s8,sp
    add     s8,s8,s8
                    #      store 4_0:i32 temp_15_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 4
    sd      a0,0(s8)
                    #      mu c_17:114 
                    #      c_17 = chi c_17:114 
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_17_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a1, 0
    li      s10, 2
    sd      a0,264(sp)
    li      a0, 0
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 2_0:i32 temp_17_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 2
    sd      a0,0(a1)
                    #      mu d_17:128 
                    #      d_17 = chi d_17:128 
                    #      new_var temp_18_17:ptr->i32 
                    #      temp_18_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a0, 0
    li      s10, 2
    sd      a1,256(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 8_0:i32 temp_18_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 8
    sd      a1,0(a0)
                    #      mu d_17:134 
                    #      d_17 = chi d_17:134 
                    #      new_var temp_19_17:ptr->i32 
                    #      temp_19_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
    li      s10, 2
    sd      a0,248(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_19_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 3
    sd      a0,0(a1)
                    #      mu d_17:140 
                    #      d_17 = chi d_17:140 
                    #      new_var temp_20_17:ptr->i32 
                    #      temp_20_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a0, 0
    li      s10, 2
    sd      a1,240(sp)
    li      a1, 1
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_21_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a1, 0
    li      s10, 2
    sd      a0,232(sp)
    li      a0, 2
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 7_0:i32 temp_21_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 7
    sd      a0,0(a1)
                    #      mu d_17:152 
                    #      d_17 = chi d_17:152 
    ...
    lw      a0,0(s10)
                    ...
                    #      temp_26_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
    sw      a0,164(sp)
    li      a0, 2
    sw      a2,220(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_26_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 3
    sd      a0,0(a1)
                    #      mu e_17:172 
                    #      e_17 = chi e_17:172 
                    #      new_var temp_27_17:ptr->i32 
                    #      temp_27_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,152(sp)
    li      a1, 0
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store temp_23_17:i32 temp_27_17:ptr->Array:i32:[Some(2_0)] 
    sd      a1,0(a0)
                    #      mu e_17:178 
                    #      e_17 = chi e_17:178 
    ...
    sd      a0,0(a2)
                    ...
                    #      temp_29_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a1, 0
    sw      a0,164(sp)
    li      a0, 2
    sd      a2,136(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 6_0:i32 temp_29_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 6
    sd      a0,0(a1)
                    #      mu e_17:190 
                    #      e_17 = chi e_17:190 
                    #      new_var temp_30_17:ptr->i32 
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,128(sp)
    li      a1, 3
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 8_0:i32 temp_30_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 8
    sd      a1,0(a0)
                    #      mu e_17:196 
                    #      e_17 = chi e_17:196 
                    #      new_var temp_31_17:ptr->i32 
                    #      temp_31_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,120(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 4_0:i32 temp_31_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 4
    sd      a0,0(a1)
                    #      mu e_17:202 
                    #      e_17 = chi e_17:202 
                    #      new_var temp_32_17:ptr->i32 
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,112(sp)
    li      a1, 2
