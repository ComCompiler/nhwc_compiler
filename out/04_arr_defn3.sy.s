...
.L0_0:
                    ...
                    #      temp_0_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    li      a2, 0
    mul     a3,a1,a2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 1_0:i32 temp_0_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a4) already exist with 1_0
    sd      a4,0(a0)
                    #      mu b_17:22 
                    #      b_17 = chi b_17:22 
                    #      new_var temp_1_17:ptr->i32 
                    #      temp_1_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a5, 0
    ...
    add     a5,a5,sp
    add     a5,a5,a5
                    #      store 5_0:i32 temp_1_17:ptr->Array:i32:[Some(2_0)] 
    li      a7, 5
    sd      a7,0(a5)
                    #      mu b_17:28 
                    #      b_17 = chi b_17:28 
    ...
    sd      a1,0(s1)
                    ...
                    #      temp_3_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(0_0)] 
    li      s3, 0
                    #found literal reg Some(a1) already exist with 2_0
    li      s4, 3
    add     s3,s3,a3
    ...
    sd      s7,0(s6)
                    ...
                    #      temp_5_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s8, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(s4) already exist with 3_0
    add     s8,s8,a3
                    #found literal reg Some(s2) already exist with 1_0
                    #found literal reg Some(a4) already exist with 1_0
    add     s8,s8,a3
    ...
    add     s8,s8,sp
    add     s8,s8,s8
                    #      store 8_0:i32 temp_5_17:ptr->Array:i32:[Some(2_0)] 
    li      s9, 8
    sd      s9,0(s8)
                    #      mu b_17:52 
                    #      b_17 = chi b_17:52 
    ...
    sd      s4,0(a1)
                    ...
                    #      temp_8_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a2, 0
                    #found literal reg Some(a6) already exist with 2_0
                    #found literal reg Some(s2) already exist with 1_0
    mul     a4,a6,s2
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 4_0:i32 temp_8_17:ptr->Array:i32:[Some(2_0)] 
    ...
    sd      a0,0(s9)
                    ...
                    #      temp_16_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a0, 0
    li      s11, 2
    sd      a1,400(sp)
    li      a1, 2
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_19_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a1, 0
    li      s11, 2
    sd      a0,248(sp)
    li      a0, 1
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_20_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a0, 0
    li      s11, 2
    sd      a1,240(sp)
    li      a1, 0
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_21_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a1, 0
    li      s11, 2
    sd      a0,232(sp)
    li      a0, 0
    ...
    lw      a0,0(s11)
                    ...
                    #      temp_26_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a1, 0
    sw      a0,164(sp)
    li      a0, 2
    sw      a2,220(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 5_0:i32 temp_26_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 5
    sd      a0,0(a1)
                    #      mu e_17:172 
                    #      e_17 = chi e_17:172 
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_28_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a2, 0
    sd      a0,144(sp)
    li      a0, 2
    sw      a1,180(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 3_0:i32 temp_28_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 3
    sd      a0,0(a2)
                    #      mu e_17:184 
                    #      e_17 = chi e_17:184 
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,112(sp)
    li      a0, 3
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 8_0:i32 temp_32_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 8
    sd      a0,0(a1)
                    #      mu e_17:208 
                    #      e_17 = chi e_17:208 
