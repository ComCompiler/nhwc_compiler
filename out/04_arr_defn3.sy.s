...
.L0_0:
                    ...
                    #      temp_0_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    li      a2, 3
    mul     a3,a1,a2
    ...
    sd      a6,0(a0)
                    ...
                    #      temp_1_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a7, 0
    ...
    sd      s2,0(a7)
                    ...
                    #      temp_2_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      s3, 0
                    #found literal reg Some(a1) already exist with 2_0
    li      s4, 2
    add     s3,s3,a3
    ...
    add     s3,s3,sp
    add     s3,s3,s3
                    #      store 6_0:i32 temp_2_17:ptr->Array:i32:[Some(2_0)] 
    li      s5, 6
    sd      s5,0(s3)
                    #      mu b_17:34 
                    #      b_17 = chi b_17:34 
                    #      new_var temp_3_17:ptr->i32 
                    #      temp_3_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s6, 0
    ...
    sd      s4,0(s6)
                    ...
                    #      temp_4_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s7, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(s1) already exist with 1_0
    add     s7,s7,a3
    ...
    sd      a2,0(s7)
                    ...
                    #      temp_5_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      s8, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(a1) already exist with 2_0
    add     s8,s8,a3
    ...
    add     s8,s8,sp
    add     s8,s8,s8
                    #      store 5_0:i32 temp_5_17:ptr->Array:i32:[Some(2_0)] 
    li      s9, 5
    sd      s9,0(s8)
                    #      mu b_17:52 
                    #      b_17 = chi b_17:52 
                    #      new_var temp_6_17:ptr->i32 
                    #      temp_6_17 = getelementptr b_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s10, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(a2) already exist with 3_0
    add     s10,s10,a3
    ...
    add     s10,s10,sp
    add     s10,s10,s10
                    #      store 8_0:i32 temp_6_17:ptr->Array:i32:[Some(2_0)] 
    li      s11, 8
    sd      s11,0(s10)
                    #      mu b_17:58 
                    #      b_17 = chi b_17:58 
    ...
    sd      s1,0(a1)
                    ...
                    #      temp_8_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a2, 0
                    #found literal reg Some(s4) already exist with 2_0
    li      a4, 2
    mul     a5,s4,a4
    ...
    add     a4,a4,a4
                    ...
                    #found literal reg Some(s5) already exist with 6_0
    sd      s5,0(a4)
                    #      mu c_17:78 
                    #      c_17 = chi c_17:78 
                    #      new_var temp_10_17:ptr->i32 
                    #      temp_10_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a6, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(s1) already exist with 1_0
    add     a6,a6,a5
    ...
    add     a6,a6,sp
    add     a6,a6,a6
                    #      store 4_0:i32 temp_10_17:ptr->Array:i32:[Some(2_0)] 
    li      s1, 4
    sd      s1,0(a6)
                    #      mu c_17:84 
                    #      c_17 = chi c_17:84 
                    #      new_var temp_11_17:ptr->i32 
                    #      temp_11_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      s1, 0
                    #found literal reg Some(s4) already exist with 2_0
    li      s2, 0
    add     s1,s1,a5
    ...
    add     s1,s1,sp
    add     s1,s1,s1
                    #      store 1_0:i32 temp_11_17:ptr->Array:i32:[Some(2_0)] 
    ...
    sd      s4,0(s2)
                    ...
                    #      temp_13_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(0_0)] 
    li      s4, 0
    li      s5, 2
    li      s9, 3
    add     s4,s4,a5
    ...
    add     s4,s4,sp
    add     s4,s4,s4
                    #      store 7_0:i32 temp_13_17:ptr->Array:i32:[Some(2_0)] 
    li      s5, 7
    sd      s5,0(s4)
                    #      mu c_17:102 
                    #      c_17 = chi c_17:102 
                    #      new_var temp_14_17:ptr->i32 
                    #      temp_14_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s5, 0
    li      s9, 2
    li      s11, 3
    add     s5,s5,a5
    ...
    add     s5,s5,sp
    add     s5,s5,s5
                    #      store 8_0:i32 temp_14_17:ptr->Array:i32:[Some(2_0)] 
    li      s9, 8
    sd      s9,0(s5)
                    #      mu c_17:108 
                    #      c_17 = chi c_17:108 
                    #      new_var temp_15_17:ptr->i32 
                    #      temp_15_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s9, 0
    li      s11, 2
    sd      a0,456(sp)
    li      a0, 0
    ...
    add     s9,s9,sp
    add     s9,s9,s9
                    #      store 2_0:i32 temp_15_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 2
    sd      a0,0(s9)
                    #      mu c_17:114 
                    #      c_17 = chi c_17:114 
                    ...
                    #      temp_16_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a0, 0
    li      s11, 2
    sd      a1,400(sp)
    li      a1, 1
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 5_0:i32 temp_16_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 5
    sd      a1,0(a0)
                    #      mu d_17:122 
                    #      d_17 = chi d_17:122 
                    #      new_var temp_17_17:ptr->i32 
                    #      temp_17_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
    li      s11, 2
    sd      a0,264(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 3_0:i32 temp_17_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 3
    sd      a0,0(a1)
                    #      mu d_17:128 
                    #      d_17 = chi d_17:128 
                    #      new_var temp_18_17:ptr->i32 
                    #      temp_18_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a0, 0
    li      s11, 2
    sd      a1,256(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_18_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu d_17:134 
                    #      d_17 = chi d_17:134 
                    #      new_var temp_19_17:ptr->i32 
                    #      temp_19_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a1, 0
    li      s11, 2
    sd      a0,248(sp)
    li      a0, 0
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 1_0:i32 temp_19_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a0) already exist with 1_0
    sd      a0,0(a1)
                    #      mu d_17:140 
                    #      d_17 = chi d_17:140 
    ...
    lw      a0,0(s11)
                    ...
                    #      temp_26_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a1, 0
    sw      a0,164(sp)
    li      a0, 2
    sw      a2,220(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 6_0:i32 temp_26_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 6
    sd      a0,0(a1)
                    #      mu e_17:172 
                    #      e_17 = chi e_17:172 
                    #      new_var temp_27_17:ptr->i32 
                    #      temp_27_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,152(sp)
    li      a1, 3
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_27_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu e_17:178 
                    #      e_17 = chi e_17:178 
                    #      new_var temp_28_17:ptr->i32 
                    #      temp_28_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,144(sp)
    li      a0, 3
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 8_0:i32 temp_28_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 8
    sd      a0,0(a1)
                    #      mu e_17:184 
                    #      e_17 = chi e_17:184 
                    #      new_var temp_29_17:ptr->i32 
                    #      temp_29_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,136(sp)
    li      a1, 0
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store temp_25_17:i32 temp_29_17:ptr->Array:i32:[Some(2_0)] 
    sd      a1,0(a0)
                    #      mu e_17:190 
                    #      e_17 = chi e_17:190 
                    #      new_var temp_30_17:ptr->i32 
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a2, 0
    sd      a0,128(sp)
    li      a0, 2
    sw      a1,164(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 4_0:i32 temp_30_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 4
    sd      a0,0(a2)
                    #      mu e_17:196 
                    #      e_17 = chi e_17:196 
                    #      new_var temp_31_17:ptr->i32 
                    #      temp_31_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    sd      a2,120(sp)
    li      a2, 1
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 3_0:i32 temp_31_17:ptr->Array:i32:[Some(2_0)] 
    li      a1, 3
    sd      a1,0(a0)
                    #      mu e_17:202 
                    #      e_17 = chi e_17:202 
                    #      new_var temp_32_17:ptr->i32 
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,112(sp)
    li      a0, 0
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store temp_23_17:i32 temp_32_17:ptr->Array:i32:[Some(2_0)] 
    sd      a0,0(a1)
                    #      mu e_17:208 
                    #      e_17 = chi e_17:208 
                    #      new_var temp_33_17:ptr->i32 
                    #      temp_33_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      a2, 0
    sw      a0,180(sp)
    li      a0, 2
    sd      a1,104(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 5_0:i32 temp_33_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 5
    sd      a0,0(a2)
                    #      mu e_17:214 
                    #      e_17 = chi e_17:214 
