...
.L0_0:
                    ...
                    #      temp_0_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a0, 0
    li      a1, 2
    li      a2, 1
    mul     a3,a1,a2
    ...
    sd      a2,0(a6)
                    ...
                    #      temp_2_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s1, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a7) already exist with 0_0
    add     s1,s1,a3
    ...
    sd      a1,0(s1)
                    ...
                    #      temp_3_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s2, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a2) already exist with 1_0
    add     s2,s2,a3
    ...
    sd      s3,0(s2)
                    ...
                    #      temp_4_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      s4, 0
                    #found literal reg Some(a1) already exist with 2_0
    li      s5, 2
    add     s4,s4,a3
    ...
    sd      s11,0(s10)
                    ...
                    #      temp_7_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      a1, 0
                    #found literal reg Some(s5) already exist with 2_0
                    #found literal reg Some(a2) already exist with 1_0
    add     a1,a1,s9
    ...
    sd      a5,0(a1)
                    ...
                    #      temp_8_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      a2, 0
                    #found literal reg Some(s5) already exist with 2_0
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 8_0:i32 temp_8_17:ptr->Array:i32:[Some(2_0)] 
    li      a4, 8
    sd      a4,0(a2)
                    #      mu c_17:74 
                    #      c_17 = chi c_17:74 
    ...
    lw      s6,0(s5)
                    ...
                    #      temp_15_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(1_0)] 
    li      s11, 0
    sd      a0,424(sp)
    li      a0, 2
    sd      a1,296(sp)
    ...
    add     s11,s11,sp
    add     s11,s11,s11
                    #      store 5_0:i32 temp_15_17:ptr->Array:i32:[Some(2_0)] 
    li      a0, 5
    sd      a0,0(s11)
                    #      mu d_17:112 
                    #      d_17 = chi d_17:112 
    ...
    sd      s6,0(a1)
                    ...
                    #      temp_18_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,184(sp)
    li      a1, 0
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 1_0:i32 temp_18_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(a1) already exist with 1_0
    sd      a1,0(a0)
                    #      mu d_17:130 
                    #      d_17 = chi d_17:130 
    ...
    lw      a0,0(a2)
                    ...
                    #      temp_25_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(0_0), Some(1_0), Some(0_0)] 
    li      a1, 0
    sw      a0,100(sp)
    li      a0, 2
    sd      a2,104(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store temp_24_17:i32 temp_25_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    sd      a0,0(a1)
                    #      mu e_17:162 
                    #      e_17 = chi e_17:162 
                    #      new_var temp_26_17:ptr->i32 
                    #      temp_26_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(0_0), Some(0_0), Some(0_0)] 
    li      a2, 0
    sw      a0,100(sp)
    li      a0, 2
    sd      a1,88(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store temp_22_17:i32 temp_26_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    sd      a0,0(a2)
                    #      mu e_17:168 
                    #      e_17 = chi e_17:168 
                    #      new_var temp_27_17:ptr->i32 
                    #      temp_27_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(3_0), Some(1_0), Some(0_0)] 
    li      a1, 0
    sw      a0,116(sp)
    li      a0, 2
    sd      a2,80(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 8_0:i32 temp_27_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 8
    sd      a0,0(a1)
                    #      mu e_17:174 
                    #      e_17 = chi e_17:174 
                    #      new_var temp_28_17:ptr->i32 
                    #      temp_28_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,72(sp)
    li      a1, 1
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 3_0:i32 temp_28_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 3
    sd      a1,0(a0)
                    #      mu e_17:180 
                    #      e_17 = chi e_17:180 
                    #      new_var temp_29_17:ptr->i32 
                    #      temp_29_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(1_0), Some(0_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,64(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 4_0:i32 temp_29_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 4
    sd      a0,0(a1)
                    #      mu e_17:186 
                    #      e_17 = chi e_17:186 
                    #      new_var temp_30_17:ptr->i32 
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(1_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,56(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 6_0:i32 temp_30_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 6
    sd      a1,0(a0)
                    #      mu e_17:192 
                    #      e_17 = chi e_17:192 
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,40(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 5_0:i32 temp_32_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 5
    sd      a1,0(a0)
                    #      mu e_17:204 
                    #      e_17 = chi e_17:204 
