...
.L0_0:
    ...
    sd      s10,0(s8)
                    ...
                    #      temp_6_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s11, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a4) already exist with 1_0
    add     s11,s11,s9
    ...
    sd      a7,0(s11)
                    ...
                    #      temp_7_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      a1, 0
                    #found literal reg Some(s4) already exist with 2_0
    li      a2, 2
    add     a1,a1,s9
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 6_0:i32 temp_7_17:ptr->Array:i32:[Some(2_0)] 
    li      a2, 6
    sd      a2,0(a1)
                    #      mu c_17:68 
                    #      c_17 = chi c_17:68 
    ...
    sd      a1,0(a0)
                    ...
                    #      temp_27_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(0_0), Some(0_0)] 
    li      a2, 0
    sd      a0,80(sp)
    li      a0, 2
    sw      a1,116(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 3_0:i32 temp_27_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 3
    sd      a0,0(a2)
                    #      mu e_17:174 
                    #      e_17 = chi e_17:174 
    ...
    sd      a0,0(a2)
                    ...
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(3_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    sd      a2,56(sp)
    li      a2, 3
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_30_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu e_17:192 
                    #      e_17 = chi e_17:192 
