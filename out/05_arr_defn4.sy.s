...
.L0_0:
    ...
    sd      s5,0(s3)
                    ...
                    #      temp_4_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      s6, 0
    ...
    li      s7, 3
                    ...
                    #      temp_5_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s8, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(a4) already exist with 1_0
    mul     s9,s4,a4
    ...
    sd      a7,0(s8)
                    ...
                    #      temp_6_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(0_0)] 
    li      s10, 0
                    #found literal reg Some(s4) already exist with 2_0
                    #found literal reg Some(a1) already exist with 2_0
    add     s10,s10,s9
    ...
    sd      a7,0(a5)
                    ...
                    #      temp_11_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      a7, 0
                    #found literal reg Some(s4) already exist with 2_0
    li      s2, 0
    add     a7,a7,s9
    ...
    sd      s2,0(a7)
                    ...
                    #      temp_12_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(2_0), Some(1_0)] 
    li      s2, 0
    li      s4, 2
    li      s5, 2
    add     s2,s2,s9
    ...
    add     s2,s2,sp
    add     s2,s2,s2
                    #      store 6_0:i32 temp_12_17:ptr->Array:i32:[Some(2_0)] 
    li      s4, 6
    sd      s4,0(s2)
                    #      mu c_17:98 
                    #      c_17 = chi c_17:98 
    ...
    add     a1,a1,a1
                    ...
                    #      temp_25_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(3_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,104(sp)
    li      a1, 3
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_25_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu e_17:162 
                    #      e_17 = chi e_17:162 
    ...
    sd      a0,0(a2)
                    ...
                    #      temp_28_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(3_0), Some(1_0), Some(0_0)] 
    li      a1, 0
    sw      a0,116(sp)
    li      a0, 2
    sd      a2,72(sp)
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 8_0:i32 temp_28_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 8
    sd      a0,0(a1)
                    #      mu e_17:180 
                    #      e_17 = chi e_17:180 
                    #      new_var temp_29_17:ptr->i32 
                    #      temp_29_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,64(sp)
    li      a1, 1
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 3_0:i32 temp_29_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 3
    sd      a1,0(a0)
                    #      mu e_17:186 
                    #      e_17 = chi e_17:186 
                    #      new_var temp_30_17:ptr->i32 
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(0_0), Some(0_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,56(sp)
    li      a0, 2
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 5_0:i32 temp_30_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 5
    sd      a0,0(a1)
                    #      mu e_17:192 
                    #      e_17 = chi e_17:192 
                    #      new_var temp_31_17:ptr->i32 
                    #      temp_31_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(1_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,48(sp)
    li      a1, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 6_0:i32 temp_31_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 6
    sd      a1,0(a0)
                    #      mu e_17:198 
                    #      e_17 = chi e_17:198 
                    #      new_var temp_32_17:ptr->i32 
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(1_0), Some(0_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,40(sp)
    li      a0, 1
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store 4_0:i32 temp_32_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 4
    sd      a0,0(a1)
                    #      mu e_17:204 
                    #      e_17 = chi e_17:204 
