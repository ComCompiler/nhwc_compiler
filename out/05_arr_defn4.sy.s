...
.L0_0:
    ...
    sd      a4,0(a7)
                    ...
                    #      temp_2_17 = getelementptr a_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      s1, 0
                    #found literal reg Some(a1) already exist with 2_0
                    #found literal reg Some(a4) already exist with 1_0
    add     s1,s1,a3
    ...
    add     s1,s1,sp
    add     s1,s1,s1
                    #      store 3_0:i32 temp_2_17:ptr->Array:i32:[Some(2_0)] 
    li      s2, 3
    sd      s2,0(s1)
                    #      mu a_17:32 
                    #      a_17 = chi a_17:32 
    ...
    sd      a1,0(s8)
                    ...
                    #      temp_6_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(3_0), Some(1_0)] 
    li      s10, 0
                    #found literal reg Some(a1) already exist with 2_0
    ...
    sd      s11,0(s10)
                    ...
                    #      temp_7_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(1_0), Some(0_0)] 
    li      a1, 0
    ...
    sd      s5,0(a4)
                    ...
                    #      temp_10_17 = getelementptr c_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(0_0)] 
    li      a5, 0
    li      a6, 2
    li      s2, 0
    add     a5,a5,s9
    ...
    add     a5,a5,sp
    add     a5,a5,a5
                    #      store 1_0:i32 temp_10_17:ptr->Array:i32:[Some(2_0)] 
                    #found literal reg Some(s4) already exist with 1_0
    sd      s4,0(a5)
                    #      mu c_17:86 
                    #      c_17 = chi c_17:86 
    ...
    lw      s5,0(s4)
                    ...
                    #      temp_15_17 = getelementptr d_17:Array:i32:[Some(4_0), Some(2_0)] [Some(0_0), Some(1_0)] 
    li      s11, 0
    sd      a0,424(sp)
    li      a0, 2
    sd      a1,296(sp)
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store temp_14_17:i32 temp_18_17:ptr->Array:i32:[Some(2_0)] 
    sd      s5,0(a0)
                    #      mu d_17:130 
                    #      d_17 = chi d_17:130 
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_26_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(0_0), Some(0_0)] 
    li      a2, 0
    sw      a0,100(sp)
    li      a0, 2
    sd      a1,88(sp)
    ...
    add     a2,a2,sp
    add     a2,a2,a2
                    #      store 5_0:i32 temp_26_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a0, 5
    sd      a0,0(a2)
                    #      mu e_17:168 
                    #      e_17 = chi e_17:168 
                    #      new_var temp_27_17:ptr->i32 
                    #      temp_27_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(1_0), Some(1_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    sd      a2,80(sp)
    li      a2, 1
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 4_0:i32 temp_27_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 4
    sd      a1,0(a0)
                    #      mu e_17:174 
                    #      e_17 = chi e_17:174 
    ...
    sd      a0,0(a1)
                    ...
                    #      temp_29_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(3_0), Some(0_0), Some(0_0)] 
    li      a0, 0
    li      a2, 2
    sd      a1,64(sp)
    li      a1, 3
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 7_0:i32 temp_29_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 7
    sd      a1,0(a0)
                    #      mu e_17:186 
                    #      e_17 = chi e_17:186 
                    #      new_var temp_30_17:ptr->i32 
                    #      temp_30_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(0_0), Some(0_0), Some(0_0)] 
    li      a1, 0
    li      a2, 2
    sd      a0,56(sp)
    li      a0, 0
    ...
    add     a1,a1,sp
    add     a1,a1,a1
                    #      store temp_22_17:i32 temp_30_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    sd      a0,0(a1)
                    #      mu e_17:192 
                    #      e_17 = chi e_17:192 
    ...
    sd      a0,0(a2)
                    ...
                    #      temp_32_17 = getelementptr e_17:Array:i32:[Some(4_0), Some(2_0), Some(1_0)] [Some(2_0), Some(1_0), Some(0_0)] 
    li      a0, 0
    li      a1, 2
    sd      a2,40(sp)
    li      a2, 2
    ...
    add     a0,a0,sp
    add     a0,a0,a0
                    #      store 6_0:i32 temp_32_17:ptr->Array:i32:[Some(2_0), Some(1_0)] 
    li      a1, 6
    sd      a1,0(a0)
                    #      mu e_17:204 
                    #      e_17 = chi e_17:204 
