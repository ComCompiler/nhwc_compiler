; ModuleID = './compiler2022/公开样例与运行时库/sylib.c'
source_filename = "./compiler2022/\E5\85\AC\E5\BC\80\E6\A0\B7\E4\BE\8B\E4\B8\8E\E8\BF\90\E8\A1\8C\E6\97\B6\E5\BA\93/sylib.c"
...
define dso_local void @_sysy_starttime(i32 %0) #0 {
  ...
  %7 = call i32 @gettimeofday(%struct.timeval* @_sysy_start, i8* null) #2
  ret void
}
...
define dso_local void @_sysy_stoptime(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = call i32 @gettimeofday(%struct.timeval* @_sysy_end, i8* null) #2
