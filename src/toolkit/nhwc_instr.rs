...
pub enum NhwcInstrType {
    ...
    Globl { var_symidx:SymIdx, vartype:Type },
    ...
    GetElementPtr { lhs:SymIdx  ,array_or_ptr_symidx:SymIdx,array_ty:Type, idx_vec:Vec<Option<SymIdx>>},
    // 算数运算符 + - * / etc.
...
impl NhwcInstrType {
    ...
    pub fn new_globl(vartype:Type, var_symidx:SymIdx) -> Self { Self::Globl { var_symidx, vartype, }  }
    ...
    pub fn new_get_element_ptr(lhs:SymIdx, array_symidx:SymIdx, array_ty:Type, idx_vec:Vec<Option<SymIdx>> ) -> Self { Self::GetElementPtr { lhs, array_or_ptr_symidx: array_symidx, array_ty, idx_vec }}
