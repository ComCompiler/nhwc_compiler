...
mod tests{
    ...
    fn find_symbol_macro_test(){
        ...
        // let data_type= find!(field TYPE:DataType at x in symtab);
        // println!("{:?}" ,data_type);
    }
    #[test]
